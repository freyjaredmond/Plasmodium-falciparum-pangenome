### A script to run produce a violin plot of the mean pLDDT scores from AlphaFold models ###
## A normality check, Kruskal-wallis and Dunn's post hoc test were performed ##
## Input: alpha fold statistics for both 3D7 (obtained directly from AlphaFold) and the alpha fold statistics for the non-3d7 genes (obtained uniprot identifier
## and retrieved the alpha fold stats (gene to uniprot id mapping was taken from PlasmoDB ##
## Output: a violin plot matching the mean pLDDT to each pangenome occupancy
...
plt.show()
fig.savefig("Functional_analysis/Alphafold/Mean_pLDDT_sixteen.png", dpi=200)
