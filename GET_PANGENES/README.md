...
and can be found in the [`Quality`](Quality) folder. Additional exploration was carried out into MSA completeness and max distance, with the MSA analysis being found in ['check_msa.py'](check_msa.py)
